<template>
  <div class="app-container">
    <div style="padding: 10px">
      <!-- <el-button type="success" @click="handleAdd"> 增加文档 </el-button> -->
    </div>
...
//         return process.env.VUE_APP_BASE_API + '/docs/' + name + '/#/?token=' + getToken();
//       };
//     },
//   },
...
//               }
//             }
//             const h = resp.data.doc.giturl.indexOf('@');
//             let domain = '';
//             if (h >= 0) {
...
//               const start = resp.data.doc.giturl.indexOf(':');
//               const newstr = resp.data.doc.giturl.slice(start + 3);
...
//             }
//             resp.data.doc.hook =
//               process.env.VUE_APP_BASE_API + '/' + platform + '/' + resp.data.doc.name;
...
//           const h = this.list[i].giturl.indexOf('@');
//           let domain = '';
//           if (h >= 0) {
...
//             // https://gitee.com/cander/scs.git
//             const start = this.list[i].giturl.indexOf(':');
//             const newstr = this.list[i].giturl.slice(start + 3);
//             const end = newstr.indexOf('/');
//             domain = newstr.slice(0, end);
//           }
//           let platform = '';
...
//           }
//           this.list[i].hook =
//             process.env.VUE_APP_BASE_API + '/' + platform + '/' + this.list[i].name;
//         }
