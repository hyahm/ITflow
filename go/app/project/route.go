...
func init() {
	...
	Project.Post("/project/add", Create).BindJson(&ProjectRequest{})

	Project.Post("/project/update", Update).BindJson(&ProjectRequest{})

	Project.Get("/project/delete", Delete).BindForm(model.Project{})
